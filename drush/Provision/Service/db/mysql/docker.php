...
class Provision_Service_db_mysql_docker extends Provision_Service_db_mysql {
  ...
  function writeEnvironmentFile() {
    $env[] = "# Automatically generated by hosting_docker.";
    $env[] = "# DO NOT ALTER. This file is written on every verify task.";
    foreach ($this->environment() as $name => $value) {
      $env[] = "{$name}={$value}";
    }

    drush_log("Writing file {$this->server->config_path}/db_secrets.env", "success");
    file_put_contents("{$this->server->config_path}/db_secrets.env", implode("\n", $env));
  }
